      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden'>
          ...
          <button
            ...
            className='w-full absolute bottom-0 inline-flex items-center justify-center gap-1.5 bg-slate-800 py-4 text-center text-sm text-red-400 outline-none font-medium hover:underline focus-visible:underline focus-visible:text-red-500'
          >
            <Trash2 className='size-3' /> Apagar essa nota
          </button>
        </Dialog.Content>
      </Dialog.Portal>
    </Dialog.Root >
