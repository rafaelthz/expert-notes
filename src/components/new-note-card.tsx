...
import { X, PlusCircle, Mic, Square } from 'lucide-react'
...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root open={isOpenedEditor} onOpenChange={setIsOpenedEditor}>
      <Dialog.Trigger className='rounded-md text-left flex flex-col bg-slate-700 max-h-[120px] md:h-full md:max-h-[250px] px-4 pt-4 pb-1 md:px-5 md:pt-5 md:pb-2 gap-2 overflow-hidden outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
